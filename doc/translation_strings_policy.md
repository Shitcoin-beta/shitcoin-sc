...
This document provides guidelines for internationalization of the Shitcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `shitcoin_en.ts` remains unchanged.
