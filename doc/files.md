...
* shitcoin.conf: contains configuration settings for shitcoind or shitcoin-qt
* shitcoind.pid: stores the process id of shitcoind while running
...
* debug.log: contains debug information and general logging generated by shitcoind or shitcoin-qt
