...
# TestP2PConn: A peer we use to send messages to shitcoind, and store responses.
...
class CompactBlocksTest(ShitcoinTestFramework):
    ...
    # This test actually causes shitcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that shitcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for shitcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # shitcoind will not send blocktxn responses for blocks whose height is
