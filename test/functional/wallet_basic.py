...
class WalletTest(ShitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 SHT from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 sht in block rewards plus fees, but
        ...
        # Send 10 SHT with subtract fee from amount
        ...
        # Sendmany 10 SHT with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/shitcoin/shitcoin/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
