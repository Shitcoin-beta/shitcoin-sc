...
"""Verify that starting shitcoin with -h works as expected."""

from test_framework.test_framework import ShitcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(ShitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start shitcoin with -h for help text")
        ...
        self.log.info("Start shitcoin with -version for version information")
        ...
        self.log.info("Start shitcoind with -fakearg to make sure it does not start")
