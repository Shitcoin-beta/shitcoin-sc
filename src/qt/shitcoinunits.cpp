...
QList<ShitcoinUnits::Unit> ShitcoinUnits::availableUnits()
{
    ...
    unitlist.append(SHT);
    unitlist.append(mSHT);
    unitlist.append(uSHT);
    unitlist.append(SAT);
    return unitlist;
}
...
QString ShitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case SHT: return QString("SHT");
    case mSHT: return QString("mSHT");
    case uSHT: return QString::fromUtf8("µSHT (bits)");
    case SAT: return QString("Shits");
...
QString ShitcoinUnits::shortName(int unit)
{
    switch(unit)
    {
    case uSHT: return QString::fromUtf8("bits");
...
QString ShitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case SHT: return QString("Shitcoins");
    case mSHT: return QString("Milli-Shitcoins (1 / 1" THIN_SP_UTF8 "000)");
    case uSHT: return QString("Micro-Shitcoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    case SAT: return QString("Shits (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
...
qint64 ShitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case SHT: return 100000000;
    case mSHT: return 100000;
    case uSHT: return 100;
    case SAT: return 1;
