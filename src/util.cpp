...
const char * const SHITCOIN_CONF_FILENAME = "shitcoin.conf";
const char * const SHITCOIN_PID_FILENAME = "shitcoind.pid";
...
bool ArgsManager::ReadConfigFiles(std::string& error, bool ignore_invalid_keys)
{
    ...
    const std::string confPath = GetArg("-conf", SHITCOIN_CONF_FILENAME);
...
fs::path GetPidFile()
{
    return AbsPathForConfigVal(fs::path(gArgs.GetArg("-pid", SHITCOIN_PID_FILENAME)));
}
