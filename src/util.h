 ...
 */
#ifndef SHITCOIN_UTIL_H
#define SHITCOIN_UTIL_H
...
extern const char * const SHITCOIN_CONF_FILENAME;
extern const char * const SHITCOIN_PID_FILENAME;
